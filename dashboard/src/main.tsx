...
const endpoints: ApiEndpoint[] = [
  ...
  { name: '사람인 동기화', method: 'POST', path: '/v1/admin/sources/SARAMIN/sync', body: '{\n  "profile": "mobility_sdv_security_cpp",\n  "mode": "incremental"\n}', admin: true },
  { name: '잡코리아 동기화', method: 'POST', path: '/v1/admin/sources/JOBKOREA/sync', body: '{\n  "profile": "mobility_sdv_security_cpp",\n  "mode": "incremental"\n}', admin: true },
