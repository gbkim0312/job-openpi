...
class Settings(BaseSettings):
    ...
    tor_socks_proxy_url: str = Field("socks5://tor:9050", alias="TOR_SOCKS_PROXY_URL")
    tor_control_enabled: bool = Field(False, alias="TOR_CONTROL_ENABLED")
    tor_control_host: str = Field("tor", alias="TOR_CONTROL_HOST")
    tor_control_port: int = Field(9051, ge=1, le=65535, alias="TOR_CONTROL_PORT")
    tor_control_password: str | None = Field(None, alias="TOR_CONTROL_PASSWORD")
